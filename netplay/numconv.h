...
static void fwrite2(unsigned short var, FILE* fp) { fwrite(uint16_to_bytes(var), 2, 1, fp); }

static void fwrite3(unsigned int var, FILE* fp) { fwrite(uint24_to_bytes(var), 3, 1, fp); }

static void fwrite4(unsigned int var, FILE* fp) { fwrite(uint32_to_bytes(var), 4, 1, fp); }
