...
HRESULT ISequentialOutStream_Ostream::Write(
    const void* aData, UINT32 aSize, UINT32* aProcessedSize)
{
    *aProcessedSize = aSize;
...
HRESULT ISequentialOutStreamCRC32_Array::Write(
    const void* aData, UINT32 aSize, UINT32* aProcessedSize)
{
...
HRESULT ISequentialOutStreamCRC32_String::Write(
    const void* aData, UINT32 aSize, UINT32* aProcessedSize)
{
...
HRESULT ISequentialOutStreamCRC32_Ostream::Write(
    const void* aData, UINT32 aSize, UINT32* aProcessedSize)
{
