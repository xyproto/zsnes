...
The last release of [ZSNES](http://zsnes.sourceforge.net/) was around 17 years ago (2007-10-31). It requires heavy patching and tweaking of compilation flags to build and run on a modern Linux distro.
