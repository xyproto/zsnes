...
/*
 * name, and how ebx is fed. 1: a ten-bit ebx, so a memory-addressing op that
 * drops the bank byte's neighbours shows up. 2: an eight-bit ebx, for the ops
 * that recompute edi = tablead[bl] - tablead has 256 entries and the index is
 * the bank/flag byte, so the port masks the upper bits (a1a3b4fb) that the
 * assembly left in; feeding them zero keeps asm and port on the same entry.
 * 0: a fully random ebx.
 */
#define OPS(X)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                               \
    X(COp80, 0)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
    X(COp18, 0)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                              \
                ...
                X(COp90, 0) X(COpB0, 0) X(COpF0, 0) X(COpD0, 0) X(COp30, 0)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
                    X(COp10, 0) X(COp50, 0) X(COp70, 0)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      \
                        X(COp1Am8, 0) X(COp1Am16, 0) X(COp3Am8, 0) X(COp3Am16, 0)                                                                                                                                                                                                                                                                                                                                                                                                                                                                            \
                            X(COp5B, 0) X(COpC2, 2) X(COpE2, 2) X(COpFB, 2)                                                                                                                                                                                                                                                                                                                                                                                                                                                                                  \
                                X(COp48m8, 0) X(COp48m16, 0) X(COp8B, 0) X(COp0B, 0) X(COp4B, 0)                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
                                    X(COpDAx8, 0) X(COpDAx16, 0) X(COp5Ax8, 0) X(COp5Ax16, 0) X(COp08, 0)                                                                                                                                                                                                                                                                                                                                                                                                                                                    \
                                        X(COp68m8, 0) X(COp68m16, 0) X(COpAB, 0) X(COpFAx8, 0) X(COpFAx16, 0)                                                                                                                                                                                                                                                                                                                                                                                                                                                \
                                            X(COp7Ax8, 0) X(COp7Ax16, 0) X(COp2B, 0) X(COp28, 2)                                                                                                                                                                                                                                                                                                                                                                                                                                                             \
                                                X(COpF4, 0) X(COpD4, 0) X(COp62, 2)                                                                                                                                                                                                                                                                                                                                                                                                                                                                          \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                ...
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                X(COpF9m8nd, 1) X(COpF9m16nd, 1) X(COpF9m8d, 1) X(COpF9m16d, 1)              \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    X(COpFDm8nd, 1) X(COpFDm16nd, 1) X(COpFDm8d, 1) X(COpFDm16d, 1)          \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        X(COpFFm8nd, 1) X(COpFFm16nd, 1) X(COpFFm8d, 1) X(COpFFm16d, 1)      \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            X(COp4C, 2) X(COp6C, 2) X(COp7C, 2) X(COp5C, 2)                  \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                X(COpDC, 2) X(COp82, 2) X(COp60, 1) X(COp6B, 1)              \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    X(COp20, 1) X(COpFC, 1) X(COp22, 1) X(COp54, 1)          \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        X(COp44, 1) X(COpCB, 1) X(COp89m8, 1) X(COp89m16, 1) \
                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                            X(COp00, 2) X(COp02, 2) X(COp40, 1)
...
int main(void)
{
    ...
    for (size_t o = 0; o < sizeof ops / sizeof ops[0]; o++) {
        ...
        DT_MAIN(12345 + (int)o, 20000)
        {
            ...
            if (ops[o].bytebx == 2)
                in.r[R_EBX] = dt_u32() & 0xFFu;
            else if (ops[o].bytebx)
