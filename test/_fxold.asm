...
SECTION .bss
NEWSYM asm_sfx128lineloc, resd 1
NEWSYM asm_sfx160lineloc, resd 1
NEWSYM asm_sfx192lineloc, resd 1
NEWSYM asm_sfxobjlineloc, resd 1
SECTION .text

NEWSYM InitFxTablesAsm
