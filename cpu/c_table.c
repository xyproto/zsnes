...
void inittable(void)
{
	...
	for (eop** i = tableA; i != endof(tableA); ++i) *i = eopINVALID;
	for (eop** i = tableB; i != endof(tableB); ++i) *i = eopINVALID;
	for (eop** i = tableC; i != endof(tableC); ++i) *i = eopINVALID;
	for (eop** i = tableD; i != endof(tableD); ++i) *i = eopINVALID;
	for (eop** i = tableE; i != endof(tableE); ++i) *i = eopINVALID;
	for (eop** i = tableF; i != endof(tableF); ++i) *i = eopINVALID;
	for (eop** i = tableG; i != endof(tableG); ++i) *i = eopINVALID;
	for (eop** i = tableH; i != endof(tableH); ++i) *i = eopINVALID;
