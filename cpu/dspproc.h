...
extern s2* Voice0BufPtr[8] ASM_ALIGNED(8); // Ptr to Buffer Block to be played
extern s4 DSPBuffer[320 * 4]; // The play buffer
extern s4 EchoBuffer[320 * 4]; // The play buffer
extern s4 EchoFB;
extern s4 FIRTAPVal0[8];
extern s4 FiltLoopR[16] ASM_ALIGNED(8);
extern s4 FiltLoop[16] ASM_ALIGNED(8);
...
extern u4 AdsrNextTimeDepth[8] ASM_ALIGNED(8);
...
extern u4 Decrease[];
extern u4 EchoRate[] ASM_ALIGNED(4);
extern u4 EnvITemp[8] ASM_ALIGNED(8);
extern u4 GainDecBendDataTime[8] ASM_ALIGNED(8);
extern u4 IncNTemp[8] ASM_ALIGNED(8);
extern u4 IncreaseBent[];
extern u4 Increase[];
extern u4 MaxEcho;
extern u4 PSampleBuf[8][24];
extern u4 SustainRate[];
extern u4 TimeTemp[8] ASM_ALIGNED(8);
extern u4 Voice0EnvInc[8] ASM_ALIGNED(8);
extern u4 Voice0Freq[8]; // Frequency of Voice (Delta Freq)
extern u4 Voice0IncNumber[8] ASM_ALIGNED(8);
extern u4 Voice0LoopPtr[8] ASM_ALIGNED(8);
extern u4 Voice0Prev0[8];
extern u4 Voice0Prev1[8];
extern u4 Voice0Ptr[8] ASM_ALIGNED(8);
extern u4 Voice0Time[8] ASM_ALIGNED(8);
extern u4 dspPAdj;
extern u4 powhack;
