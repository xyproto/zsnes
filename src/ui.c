...
unsigned char opexec358     = 155;  // # of opcodes/scanline in 3.58Mhz mode (228/180)
...
void GetFilename();
extern unsigned char firstsaveinc,LatestSave,newestfileloc,newestfileloc10,slotlevelnum;
void DetermineNew();
...
void zst_init()
{
  ...
  if(LatestSave)
  {
    ...
    else
    {
      ...
      slotlevelnum = newestfileloc10+'0';
    }
