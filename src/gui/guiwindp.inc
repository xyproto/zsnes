...
%endif
  ...
  GUIDisplayCheckboxu 3,5,170,pl12s34,GUIInputTextE7,0
  GUIDisplayCheckboxu 3,5,180,AllowUDLR,GUIInputTextE8,0
  GUIDisplayCheckboxu 3,105,180,Turbo30hz,GUIInputTextE9,0
...
GUIInputTextE7 db 'USE PL3/4 AS PL1/2',0
GUIInputTextE8 db 'ALLOW U+D/L+R',0
GUIInputTextE9 db 'TURBO AT 30HZ',0
...
%endif
  ...
  GUIDisplayCheckboxu 4,11,68,newengen,GUIOptionTextB1,4
  cmp byte[newengen],0
  jne near .newengen
  GUIDisplayCheckboxu 4,11,78,bgfixer,GUIOptionTextB2,4
.newengen

  GUIDisplayTextY 4,140,63,GUIOptionTextF
...
GUIOptionTextB db 'GFX ENGINES:',0
GUIOptionTextB1 db 'USE NEW GFX ENG',0
GUIOptionTextB2 db 'USE ALT OLD GFX ENG',0
...
.nocheckboxw
  ...
  GUIDisplayTextY 5,13,110,GUIVideoTextB3         ; Misc Filters
  GUIDisplayCheckboxu 5,18,115,GrayscaleMode,GUIVideoTextB3a,0  ; Grayscale
  ...
  cmp byte[newengen],0
  je near .nocheckboxm72
  GUIDisplayCheckboxu 5,128,115,Mode7HiRes16b,GUIVideoTextB3b,0
.nocheckboxm72
                                                  ; Monitor Refresh
...
GUIVideoTextB3 db 'MISC FILTERS:',0      ; Filters.Other
GUIVideoTextB3a db 'GRAYSCALE MODE',0    ; -v8
GUIVideoTextB3b db 'HI-RES MODE 7',0     ;
...
DisplayGUISound:                     ; Sound Related Options
  ...
  GUIDisplayCheckboxu 6,11,21,SPCDisable,GUISoundTextA1,0
...
.nopal1b
  ...
  GUIDisplayCheckboxu 10,12,33,lhguimouse,GUIGUIOptnsTextA1b,15
...
.noolddump
  ...
  DrawGUIButton 15,7,109,50,120,GUIMovieTextD1,29,0,0
  DrawGUIButton 15,85,109,138,120,GUIMovieTextD2,30,0,0
  DrawGUIButton 15,173,109,203,120,GUIMovieTextD3,31,0,0

  DDrawBox 15,57,110,[KeyInsrtChap]        ; Chapter Keyboard Shortcut Boxes
...
.notcontrols
  ...
  GUIDisplayButtonHoleTu 15,9,64,byte[MovieVideoMode],0,GUIMovieTextF1,1
  GUIDisplayButtonHoleTu 15,9,74,byte[MovieVideoMode],1,GUIMovieTextF2,2
  GUIDisplayButtonHoleTu 15,9,84,byte[MovieVideoMode],2,GUIMovieTextF3,0
  GUIDisplayButtonHoleTu 15,9,94,byte[MovieVideoMode],3,GUIMovieTextF4,9
  GUIDisplayButtonHoleTu 15,9,104,byte[MovieVideoMode],4,GUIMovieTextF5,0
  GUIDisplayButtonHoleTu 15,9,114,byte[MovieVideoMode],5,GUIMovieTextF6,0

  GUIDisplayTextY 15,129,56,GUIMovieTextG           ; Audio Section
  GUIDisplayTextY 15,162,154,GUIMovieTextI
...
.nomux
  ...
  GUIOuttextwin2d 15,139,139,GUIMovieForcedText,10
.nodumping
